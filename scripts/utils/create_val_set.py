...
# Example usage
source_directory = "vctk-small"  # Replace with the source directory
destination_directory = "vctk-small-val"  # Replace with the destination directory
copy_random_audio_files(source_directory, destination_directory, 100)
