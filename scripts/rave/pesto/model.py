...
from .shift_cqt import PitchShiftCQT
from .cqt_transforms import BatchRandomNoise, BatchRandomGain
...
class PESTO(nn.Module):
    def __init__(self,
        ...
        #default values for training (needs to be scriptable)
        max_steps = 3 * 11 // 2
        min_steps = -max_steps
    ...
    def forward(self, audio_data: torch.Tensor) -> OUTPUT_TYPE:
        ...
        cqt = self.preprocessor(audio_data).flatten(0, 1)
