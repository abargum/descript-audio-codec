...
from modules.encoder import Encoder, PitchEncoder
...
def main():
    ...
    pitch_encoder = PitchEncoder(data_size = 6,
                                capacity = 16,
                                ratios = [4, 4, 2, 2],
                                latent_size = 1440,
                                n_out = 1,
    ...
    pitch_encoder.load_state_dict(torch.load(f"scripts/utils/caus_pitch_enc_16.pth", weights_only=True))
    pitch_encoder.eval()
